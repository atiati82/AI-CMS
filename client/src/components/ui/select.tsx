...
>(({ className, children, variant = "default", ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      "flex h-9 w-full items-center justify-between whitespace-nowrap rounded-md px-3 py-2 text-sm shadow-sm ring-offset-background disabled:cursor-not-allowed disabled:opacity-50 [&>span]:line-clamp-1",
      variant === "dark"
        ? "bg-white/5 text-white outline outline-1 -outline-offset-1 outline-white/10 data-[placeholder]:text-gray-500 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-500"
        : "border border-input bg-transparent data-[placeholder]:text-muted-foreground focus:outline-none focus:ring-1 focus:ring-ring",
      className
    )}
    {...props}
  >
