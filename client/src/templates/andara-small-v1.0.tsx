/**
 * Andara Small Template v1.0
 * 
 * A compact, elegant science page template with:
 * - Hero section with gradient background and animated icon
 * - TL;DR summary box
 * - Facet cards (2x2 or 4-column grid)
 * - Properties feature box
 ...
 * 
 * Based on: /science/crystalline-matrix
 * 
 * Usage: Copy this template and customize the data arrays and content.
 * Replace placeholder content with your topic-specific information.
 */

import { Link } from "wouter";
import { ArrowLeft, ArrowRight, Hexagon, Sparkles, Droplet, Leaf, Heart, Zap, Grid3X3, Atom, LucideIcon } from "lucide-react";
...
// Stagger variants from unified motion system
const staggerContainer = stagger.container;
const staggerItem = stagger.item;

// ============================================================================
// TEMPLATE CONFIGURATION - Customize these for your page
// ============================================================================
...
const config: TemplateConfig = {
  pageSlug: "crystalline-matrix",
  categoryLabel: "Crystalline Matrix",
  categoryIcon: Hexagon,
  
  heroTitle: "Where Geometry, Water, and Minerals",
  heroTitleHighlight: "Become Living Structure",
  heroSubtitle: "Beyond chemistry lies an ordered, geometric architecture that shapes water, minerals and biological life. Discover how crystalline fields create coherence, charge and vitality.",
  tldr: "This page reveals the multidimensional science of crystalline structure: how water, minerals and living tissues form geometric order that supports bioelectricity, detox, vitality and resonance.",
  ctaText: "Explore Andara Ionic Minerals",
  ctaLink: "/shop/andara-ionic-100ml",
  
  accentGradientFrom: "indigo",
  accentGradientTo: "cyan",
};
...
export default function AndaraSmallTemplate() {
      ...
      <article className="min-h-screen">
        ...
        <section className="relative overflow-hidden bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950 py-24 md:py-32">
          ...
          <div className="container mx-auto px-4 max-w-5xl relative z-10">
            ...
            >
              {/* Category badge with animated icon */}
        ...
        {/* SOLUTION SECTION - The Andara Perspective */}
